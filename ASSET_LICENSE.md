...
- 📛 **署名（BY）** — 必须标明原作者 / 来源链接，**并标明是否做了修改**
- 🚫🚫 **非商用（NC）** — **不得用于任何商业目的**
- 🔁 **相同方式共享（SA）** — 如果你改编了，必须用**同样的 CC BY-NC-SA 4.0** 协议发布
...
```
素材来自：meme-api (https://github.com/shumengya/meme-api)
...
```
来源：shumengya/meme-api (CC BY-NC-SA 4.0)
```

## 关于商用

CC BY-NC-SA 的 **NC（NonCommercial）** 含义：
...
1. 确认你对所投稿素材拥有合法分发权利（自己原创 / 协议允许 / 来源已授权）
2. 同意本仓库按 **CC BY-NC-SA 4.0** 协议发布你的投稿
3. 同意其他人在遵守上述协议的前提下使用、改编、再分发你的投稿

如果你的素材使用了**他人的原始素材**，请在 PR 描述里写明出处与原始协议。
...
- 为什么不是 MIT？表情包是**艺术作品 / 二次创作**，加上 **NC** 可以避免被无差别商用剽窃，加上 **SA** 可以让衍生作品保持开放。
- 为什么不是 CC BY-SA？NC 限制可以保护作者署名权益，避免"我做的素材被人用在付费壁纸 APP 里"。
